...
- főoldal a kötelező navigációval, H1 címmel és lábléccel
- JavaScript CRUD
- React CRUD
- SPA két miniappal
- Fetch API CRUD
...
- `backend/public`
  a publikált oldalak és az API belépési pontja
- `backend/src`
  a PHP repository és szerveroldali logika
- `backend/migrations`
  adatbázis séma
- `backend/scripts`
  bootstrap és segédszkriptek
- `deploy`
...
A projekt beadásközeli állapotban van. A kötelező funkcionális blokkok elkészültek, az élő tárhelyes futás és az adatbázis-alapú szerveroldali mentés működik, a dokumentáció és a képernyőképek pedig a `docs` mappában találhatók.
